const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./Home-CP2rKlZ6.js","./index-CC6Gx0up.js","./Home-CPpPLh6t.css","./BookDetail-C4rXjIe-.js","./search-DMIniWdO.js","./search-CHNbeiQb.css","./index-CUCe2A1O.js","./BookDetail-CNP7St3N.css","./AddBook-BxPxB4nM.js","./AddBook-EvhE86ME.css","./StatisticsNew-Uh7ZUS_F.js","./StatisticsNew-9hau8ih4.css","./Settings-BRC39xMR.js","./Settings-BZBlo4h5.css"])))=>i.map(i=>d[i]);
// @__NO_SIDE_EFFECTS__
...
const useBookStore = /* @__PURE__ */ defineStore("book", () => {
  const books = ref([]);
  ...
  const filteredBooks = computed(() => {
    ...
    if (searchKeyword.value.trim()) {
      ...
      result = result.filter(
        (book) => book.title.toLowerCase().includes(keyword) || book.author?.toLowerCase().includes(keyword) || book.description?.toLowerCase().includes(keyword)
      );
    }
  ...
  async function createBook$1(input) {
    loading.value = true;
    try {
  ...
  async function updateBook$1(id, input) {
    loading.value = true;
    try {
  ...
  async function deleteBook$1(id) {
    loading.value = true;
    try {
      await deleteBook(id);
  ...
  async function searchBooks$1(keyword) {
    ...
    try {
      ...
      books.value = await searchBooks(keyword);
    } catch (error) {
  ...
  async function batchUpdateStatus(bookIds, status) {
    loading.value = true;
    try {
      const updatePromises = bookIds.map(
        (id) => updateBook(id, { reading_status: status })
      );
  ...
  return {
    ...
    fetchBooks,
    fetchBookById,
    createBook: createBook$1,
    updateBook: updateBook$1,
    deleteBook: deleteBook$1,
    searchBooks: searchBooks$1,
    setSearchKeyword,
    clearSearch,
    setCurrentBook,
    setSelectedStatus,
...
const _hoisted_7 = { class: "topbar" };
const _hoisted_8 = { class: "topbar-left" };
const _hoisted_9 = { class: "topbar-actions" };
const _hoisted_10 = ["title"];
const _hoisted_11 = { class: "view-wrapper" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("aside", {
          class: normalizeClass(["sidebar", { collapsed: unref(uiStore).sidebarCollapsed }])
        }, [
          _cache[4] || (_cache[4] = createBaseVNode("div", { class: "brand" }, [
            createBaseVNode("div", { class: "logo" }, "iBook"),
            createBaseVNode("p", null, "本地网络小说管理器")
          ], -1)),
          createBaseVNode("nav", _hoisted_2, [
            (openBlock(), createElementBlock(Fragment, null, renderList(navItems, (item) => {
              return createVNode(unref(RouterLink), {
                key: item.name,
                to: item.path,
                class: normalizeClass(["nav-link", { active: activeRoute.value === item.name }])
              }, {
                default: withCtx(() => [
                  createBaseVNode("span", _hoisted_3, toDisplayString(item.icon), 1),
          ...
          createBaseVNode("div", _hoisted_5, [
            createBaseVNode("button", {
              ...
              (...args) => unref(uiStore).toggleSidebar && unref(uiStore).toggleSidebar(...args))
            }, toDisplayString(unref(uiStore).sidebarCollapsed ? "展开侧边栏" : "折叠侧边栏"), 1)
          ])
        ], 2),
        unref(uiStore).sidebarCollapsed ? (openBlock(), createElementBlock("button", {
          key: 0,
          ...
          createBaseVNode("span", null, "展开菜单", -1)
        ])])) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_6, [
          createBaseVNode("header", _hoisted_7, [
            createBaseVNode("div", _hoisted_8, [
              createBaseVNode("button", {
                class: "ghost-btn mobile-only",
                type: "button",
                onClick: _cache[2] || (_cache[2] = //@ts-ignore
                (...args) => unref(uiStore).toggleSidebar && unref(uiStore).toggleSidebar(...args))
              }, toDisplayString(unref(uiStore).sidebarCollapsed ? "☰" : "✕"), 1),
              _cache[6] || (_cache[6] = createBaseVNode("h1", null, "阅读记录", -1))
            ]),
            createBaseVNode("div", _hoisted_9, [
              createBaseVNode("button", {
                ...
                (...args) => unref(uiStore).toggleTheme && unref(uiStore).toggleTheme(...args))
              }, toDisplayString(unref(uiStore).getEffectiveTheme() === "dark" ? "🌙" : "☀️"), 9, _hoisted_10)
            ])
          ]),
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e2d0af20"]]);
  ...
  routes: [
    {
      path: "/",
      name: "Home",
      component: () => __vitePreload(() => import("./Home-CP2rKlZ6.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url)
    },
    {
      path: "/book/:id",
      name: "BookDetail",
      component: () => __vitePreload(() => import("./BookDetail-C4rXjIe-.js"), true ? __vite__mapDeps([3,4,5,1,6,7]) : void 0, import.meta.url)
    },
    {
      path: "/add",
      name: "AddBook",
      component: () => __vitePreload(() => import("./AddBook-BxPxB4nM.js"), true ? __vite__mapDeps([8,4,5,9]) : void 0, import.meta.url)
    },
    {
      path: "/statistics",
      name: "Statistics",
      component: () => __vitePreload(() => import("./StatisticsNew-Uh7ZUS_F.js"), true ? __vite__mapDeps([10,1,6,11]) : void 0, import.meta.url)
    },
    {
      path: "/settings",
      name: "Settings",
      component: () => __vitePreload(() => import("./Settings-BRC39xMR.js"), true ? __vite__mapDeps([12,13]) : void 0, import.meta.url)
    }
  ]
});
...
export {
  ...
  h as al,
  watchEffect as am,
  onScopeDispose as an,
  getCurrentScope as ao,
  warn as ap,
  camelize as aq,
  shallowReactive as ar,
  withDirectives as b,
