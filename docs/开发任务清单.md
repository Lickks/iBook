...
- [ ] **2.2 数据库服务实现**
  - [ ] 创建 `electron/services/database.ts`
  - [ ] 实现数据库初始化
  - [ ] 实现书籍 CRUD
    - [ ] createBook
    - [ ] getBookById
...
- [ ] **3.3 IPC 处理器**
  - [ ] 创建 `electron/ipc/bookHandler.ts`
    - [ ] book:create
    - [ ] book:update
    - [ ] book:delete
    - [ ] book:getById
    - [ ] book:getAll
    - [ ] book:search
  - [ ] 创建 `electron/ipc/documentHandler.ts`
    - [ ] document:upload
    - [ ] document:delete
    - [ ] document:open
    - [ ] document:countWords
  - [ ] 创建 `electron/ipc/searchHandler.ts`
    - [ ] search:youshu
...
- [ ] **4.2 状态管理**
  - [ ] 创建 `src/stores/book.ts`
    - [ ] state: books, currentBook, loading
    - [ ] getters: filteredBooks, totalWordCount
    - [ ] actions: fetchBooks, createBook, updateBook, deleteBook
  - [ ] 创建 `src/stores/ui.ts`
    - [ ] state: theme, viewMode, sidebarCollapsed
    - [ ] actions: toggleTheme, setViewMode
...
- [ ] **4.3 API 层**
  - [ ] 创建 `src/api/book.ts`
    ...
    - [ ] delete(id)
    - [ ] search(keyword)
  - [ ] 创建 `src/api/document.ts`
  - [ ] 创建 `src/api/search.ts`
...
- [ ] **5.3 书籍卡片组件**
  - [ ] 创建 `src/components/BookCard.vue`
  - [ ] 展示封面
  - [ ] 展示书名、作者
  - [ ] 展示字数、评分
  - [ ] 展示阅读状态
...
- [ ] **5.4 添加书籍页面（手动录入）**
  - [ ] 创建 `src/views/AddBook.vue`
  - [ ] 创建 `src/components/BookForm.vue`
  - [ ] 表单字段
    - [ ] 书名（必填）
    - [ ] 作者
    - [ ] 封面上传
...
- [ ] **6.1 爬虫服务实现**
  - [ ] 创建 `electron/services/spider.ts`
  - [ ] 分析 youshu.me 网页结构
  - [ ] 实现搜索功能
  - [ ] 解析搜索结果
  - [ ] 提取书籍信息
